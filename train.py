...
#测试运行代码：python train.py -c configs/config.yaml
# 测试视频文件: python demo.py --video_file  --model_file  --out_dir output/
# 测试图片（Windows系统）:python demo.py --image_dir data/test_image --model_file --out_dir output/